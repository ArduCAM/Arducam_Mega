...
/**
  ...
  */
typedef enum {
	CAM_CONTRAST_LEVEL_3=6,         /**<Level -3 */
	CAM_CONTRAST_LEVEL_2=4,         /**<Level -2 */
	CAM_CONTRAST_LEVEL_1=2,         /**<Level -1 */
	CAM_CONTRAST_LEVEL_DEFAULT=0,   /**<Level Default*/
	CAM_CONTRAST_LEVEL1=1,          /**<Level +1 */
	CAM_CONTRAST_LEVEL2=3,          /**<Level +2 */
	CAM_CONTRAST_LEVEL3=5,          /**<Level +3 */
}CAM_CONTRAST_LEVEL;
...
/**
  ...
  */
typedef enum {
	CAM_EV_LEVEL_3=6,         /**<Level -3 */
	CAM_EV_LEVEL_2=4,         /**<Level -2 */
	CAM_EV_LEVEL_1=2,         /**<Level -1 */
	CAM_EV_LEVEL_DEFAULT=0,   /**<Level Default*/
	CAM_EV_LEVEL1=1,          /**<Level +1 */
	CAM_EV_LEVEL2=3,          /**<Level +2 */
	CAM_EV_LEVEL3=5,          /**<Level +3 */
}CAM_EV_LEVEL;                       
...
/**
  ...
  */                                    
typedef enum {
	CAM_STAURATION_LEVEL_3=6,         /**<Level -3 */
	CAM_STAURATION_LEVEL_2=4,         /**<Level -2 */
	CAM_STAURATION_LEVEL_1=2,         /**<Level -1 */
	CAM_STAURATION_LEVEL_DEFAULT=0,   /**<Level Default*/
	CAM_STAURATION_LEVEL1=1,          /**<Level +1 */
	CAM_STAURATION_LEVEL2=3,          /**<Level +2 */
	CAM_STAURATION_LEVEL3=5,          /**<Level +3 */
...
/**
  ...
  */       
typedef enum {
	CAM_BRIGHTNESS_LEVEL_4=8,          /**<Level -4 */
	CAM_BRIGHTNESS_LEVEL_3=6,          /**<Level -3 */
	CAM_BRIGHTNESS_LEVEL_2=4,          /**<Level -2 */
	CAM_BRIGHTNESS_LEVEL_1=2,          /**<Level -1 */
	CAM_BRIGHTNESS_LEVEL_DEFAULT=0,    /**<Level Default*/
	CAM_BRIGHTNESS_LEVEL1=1,           /**<Level +1 */
	CAM_BRIGHTNESS_LEVEL2=3,           /**<Level +2 */
	CAM_BRIGHTNESS_LEVEL3=5,           /**<Level +3 */
	CAM_BRIGHTNESS_LEVEL4=7,		   /**<Level +4 */
...
//**********************************************
//!
//! @brief Create a camera module instance
//!
...
//! @param MyCamera ArducamCamera instance
...
//**********************************************
CamStatus takeMultiPictures(ArducamCamera*MyCamera, CAM_IMAGE_MODE mode, CAM_IMAGE_PIX_FMT pixel_format, uint8_t number);
